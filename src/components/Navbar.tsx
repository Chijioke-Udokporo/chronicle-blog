...
export function Navbar() {
  ...
  return (
    <header class="border-b border-stone-200 bg-[#faf9f6]/95 backdrop-blur sticky top-0 z-50 transition-colors">
        ...
        <div class="flex items-center justify-between h-20">
          ...
          <div class="flex items-center gap-6">
            <a href="/" class="group flex items-baseline gap-2 text-inherit no-underline">
              <span class="font-serif text-3xl font-black tracking-tight text-stone-900 group-hover:text-amber-800 transition-colors">
              ...
              <span class="hidden sm:inline-block text-xs font-mono tracking-widest text-amber-700 uppercase">
          ...
          <nav class="flex items-center gap-6">
            <a href="/" class="text-sm font-medium text-stone-600 hover:text-stone-950 transition-colors">
          <nav class="flex items-center gap-4 sm:gap-6">
            ...
            <Show when={isAuthenticated()}>
              <a href="/dashboard" class="text-sm font-medium text-stone-600 hover:text-stone-950 transition-colors">
              ...
              <a
                href="/write"
                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-stone-900 rounded-full hover:bg-stone-800 transition-all shadow-sm active:scale-95"
            ...
            <Show
              ...
              fallback={
                <div class="flex items-center gap-3">
                  <a
                    href="/login"
                    class="text-sm font-medium text-stone-700 hover:text-stone-950 px-3 py-2 transition-colors"
                  ...
                  <a
                    href="/register"
                    class="px-4 py-2 text-sm font-medium text-stone-900 border border-stone-300 rounded-full hover:border-stone-900 transition-colors"
            ...
            >
              <div class="relative">
                <button
                  ...
                  class="flex items-center gap-2 p-1 rounded-full hover:ring-2 hover:ring-stone-300 transition-all cursor-pointer"
                ...
                >
                  <img
                    ...
                    class="w-9 h-9 rounded-full bg-stone-100 border border-stone-200 object-cover"
                  ...
                  />
                  <span class="hidden md:inline-block text-sm font-medium text-stone-800 max-w-[120px] truncate">
                ...
                <Show when={dropdownOpen()}>
                  <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-stone-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                    <div class="px-4 py-2 border-b border-stone-100">
                      <p class="text-xs text-stone-500 font-mono">Signed in as</p>
                      <p class="text-sm font-semibold text-stone-900 truncate">{user()?.email}</p>
