export function Footer() {
  return (
    <footer class="border-t border-stone-200 bg-[#f4f2ed] mt-24 py-16 text-stone-600">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div class="md:col-span-2">
            <a href="/" class="font-serif text-2xl font-black tracking-tight text-stone-900">
            <a href="/" class="font-serif text-2xl font-black tracking-tight text-stone-900 dark:text-stone-100">
              CHRONICLE
            </a>
            <p class="mt-4 text-sm text-stone-600 max-w-sm leading-relaxed">
            ...
            <div class="mt-6 flex items-center gap-4 text-xs font-mono text-stone-500">
          ...
          <div>
            <h3 class="text-xs font-mono tracking-wider uppercase text-stone-900 font-semibold mb-4">Sections</h3>
        ...
        <div class="mt-12 pt-8 border-t border-stone-200/60 flex flex-col sm:flex-row items-center justify-between text-xs text-stone-500">
